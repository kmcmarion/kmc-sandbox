    ...
    "features": [
        {
            "properties": {
                ...
                "image": "https://kmc.solutions/media/tjxhbzfp/building1.png"
            }
        },
        {
            "properties": {
                ...
                "image": "https://kmc.solutions/media/o5ppehv0/featured.jpg"
            }
        },
        {
            "properties": {
                ...
                "image": "https://kmc.solutions/media/nfbpraax/sm-aura-office-space.jpg"
            }
        },
        {
            "properties": {
                ...
                "image": "https://kmc.solutions/media/tlnha4hv/coworking-space-bgc.jpg"
            }
        },
        {
            "properties": {
                ...
                "image": "https://kmc.solutions/media/m0afb3qj/1.jpg"
            }
        },
        {
            "properties": {
                ...
                "image": "https://kmc.solutions/media/rsmbol0i/netquad.jpg"
        ...
        },
        {
            "properties": {
                ...
                "image": "https://kmc.solutions/media/h0opwt0m/v-corp-office-space.jpeg"
        ...
        },
        {
            "properties": {
                ...
                "image": "https://kmc.solutions/media/n3pjb1w4/frabelle_coworking_ogimg.jpg"
            }
        },
        {
            "properties": {
                ...
                "image": "https://kmc.solutions/media/xcip2uvk/rufino-card-photo.jpg"
            }
        },
        {
            "properties": {
        ...
        },
        {
            "properties": {
                ...
                "image": "https://kmc.solutions/media/fwyfvajn/office-space-ortigas.jpg"
            }
        },
        {
            "properties": {
                ...
                "image": "https://kmc.solutions/media/bpgck0if/gamma.jpg"
            }
        },
        {
            "properties": {
                ...
                "image": "https://kmc.solutions/media/1i5nwiqi/kmc-office-in-rbc-3.jpg"
            }
        },
        {
            "properties": {
                ...
                "image": "https://kmc.solutions/media/33cjvqei/office-space-in-podium-west-tower.jpg"
            }
        },
        {
            "properties": {
                ...
                "image": "https://kmc.solutions/media/1rulssth/2.jpg"
            }
        },
        {
            "properties": {
                ...
                "image": "https://kmc.solutions/media/n43bdzvu/zeta.jpg"
        ...
        },
        {
            "properties": {
                ...
                "image": "https://kmc.solutions/media/n0ukeq3a/office-space-alabang.jpg"
            }
        },
        {
            "properties": {
                ...
                "city": "Pasay",
                "link": "#",
                "image": "https://kmc.solutions/media/eoadwo2u/office-space-in-five-e-com.jpg"
            }
        },
        {
            "properties": {
                ...
                "image": "https://kmc.solutions/media/vt4bh4xm/service-office-cebu.jpg"
            }
        },
        {
            "properties": {
                ...
                "image": "https://kmc.solutions/media/nmwpo3g3/1.jpg"
            }
        },
        {
            "properties": {
                ...
                "image": "https://kmc.solutions/media/vgdbbzgi/virtual-office-iloilo.jpg"
            }
        },
        {
            "properties": {
                ...
                "image": "https://kmc.solutions/media/cwanmsqd/featured.jpg"
            }
        }
    ]
}

// Loop through mobileBranches
// Filter the mobileBranches with the selected item
// Pass the prop to setCity function
// Display the props in HTML format
$(document).ready(function () {
    $("#cityList").trigger("change")
})

$("#cityList").on("change blur", function () {
    $("#buildingList").text('')
    var city = $(this).val()
    for (branch in mobileBranches.features) {
        var prop = mobileBranches.features[branch].properties
        if (prop.city == city) {
            setCity(prop)
        }
    }
...
function setCity(prop) {
    $("#buildingList").append(`
    <div class='card mb-2 p-2'>
        <img class="card-img-top" src="${prop.image}" alt="Card image cap">
        <div class='card-body'>
            <h3 class='card-title font-weight-bold'><a href='http://lkmc.solutions${prop.link}'>${prop.buildingName}</a></h3>
            <p>${prop.address}</p>
            <p>${prop.phone}</p>
        </div>
    </div>
