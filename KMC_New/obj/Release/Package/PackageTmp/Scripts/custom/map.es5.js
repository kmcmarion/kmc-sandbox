...
var branches = {
    ...
    "features": [{
        ...
        "properties": {
            ...
            "city": "BGC",
            "link": "/bgc-taguig/uptown-place-tower-2/",
        ...
        "geometry": {
            "type": "Point",
            "coordinates": [121.04301, 14.53518]
        },
        "properties": {
        ...
        "geometry": {
            "type": "Point",
            "coordinates": [121.05292, 14.54511]
        },
        "properties": {
            ...
            "city": "BGC",
            "link": "/bgc-taguig/sm-aura-office-tower/",
            "coords": [121.049569, 14.545188]
        }
    }, {
        "type": "Feature",
        "geometry": {
            "type": "Point",
            "coordinates": [121.04597, 14.54993]
        },
        "properties": {
            ...
            "city": "BGC",
            "link": "/bgc-taguig/picadilly-star/",
            "coords": [121.049569, 14.545188]
        }
    }, {
        "type": "Feature",
        "geometry": {
            "type": "Point",
            "coordinates": [121.04621, 14.54786]
        },
        "properties": {
            ...
            "city": "BGC",
            "link": "/bgc-taguig/sun-life-centre/",
            "coords": [121.049569, 14.545188]
        }
    }, {
        "type": "Feature",
        "geometry": {
            "type": "Point",
            "coordinates": [121.04704, 14.55296]
        },
        "properties": {
        ...
        "geometry": {
            "type": "Point",
            "coordinates": [121.05122, 14.55243]
        },
        "properties": {
        ...
        "geometry": {
            "type": "Point",
            "coordinates": [121.02477, 14.56033]
        },
        "properties": {
            ...
            "city": "Makati",
            "link": "/makati/v-corporate-centre/",
        ...
        "properties": {
            ...
            "city": "Makati",
            "link": "/makati/frabelle-corporate-plaza/",
            "coords": [121.025867, 14.557385]
        }
    }, {
        "type": "Feature",
        "geometry": {
            "type": "Point",
            "coordinates": [121.01823, 14.55803]
        },
        "properties": {
            ...
            "city": "Makati",
            "link": "/makati/rufino-pacific-tower/",
            "coords": [121.025867, 14.557385]
        }
    }, {
        "type": "Feature",
        "geometry": {
            "type": "Point",
            "coordinates": [121.06356, 14.58712]
        },
        "properties": {
        ...
        "properties": {
            ...
            "city": "Ortigas",
            "link": "/ortigas/rockwell-business-center/",
            "coords": [121.059914, 14.584400]
        }
    }, {
        "type": "Feature",
        "geometry": {
            "type": "Point",
            "coordinates": [121.06068, 14.58718]
        },
        "properties": {
            ...
            "city": "Ortigas",
            "link": "/ortigas/robinsons-cyberscape-gamma/",
            "coords": [121.059914, 14.584400]
        }
    }, {
        "type": "Feature",
        "geometry": {
            "type": "Point",
            "coordinates": [121.06834, 14.58969]
        },
        "properties": {
            ...
            "city": "Ortigas",
            "link": "/ortigas/rockwell-business-center-tower-3/",
            "coords": [121.059914, 14.584400]
        }
    }, {
        "type": "Feature",
        "geometry": {
            "type": "Point",
            "coordinates": [121.05951, 14.586251]
        },
        "properties": {
            ...
            "city": "Mandaluyong",
            "link": "/mandaluyong/podium-west-tower/",
        ...
        "geometry": {
            "type": "Point",
            "coordinates": [121.05517, 14.57635]
        },
        "properties": {
            ...
            "city": "Mandaluyong",
            "link": "/mandaluyong/rockwell-sheridan-1/",
        ...
        "properties": {
            ...
            "city": "Quezon City",
            "link": "/quezon-city/robinsons-zeta-tower",
        ...
        "geometry": {
            "type": "Point",
            "coordinates": [121.03659, 14.41881]
        },
        "properties": {
    ...
    //    },
    //    "properties": {
    //        "buildingName": "Four E-Com Center",
    //        "phone": "(02) 8779 6540",
    ...
    //},
    {
        ...
        "geometry": {
            "type": "Point",
            "coordinates": [123.90637, 10.33018]
        },
        "properties": {
        ...
        "geometry": {
            "type": "Point",
            "coordinates": [123.90637, 10.33015]
        },
        "properties": {
        ...
        "properties": {
            ...
            "city": "Iloilo",
            "link": "/iloilo/festive-walk-tower/",
        ...
        "geometry": {
            "type": "Point",
            "coordinates": [120.573504, 15.178493]
        },
        "properties": {
...
map.on('load', function (e) {
    ...
    branches.features.forEach(function (marker) {
...
function buildLocationList(data) {
    ...
    for (e = 0; e < cityList.length; e++) {
        ...
        header.addEventListener('click', function (e) {
            ...
            cityIndex = cityList.map(function (e) {
                return e.city;
            }).indexOf(clickedCity);
...
function createPopUp(currentFeature) {
    ...
    var popUp = new mapboxgl.Popup({ closeOnClick: false }).setLngLat(currentFeature.geometry.coordinates).setHTML('<h3 style="color: #000;">' + '<a href="' + currentFeature.properties.link + '">' + currentFeature.properties.buildingName + '</a></h3>' + '<p style="color: #000">' + currentFeature.properties.address + '</p>' + '<a href="tel:' + currentFeature.properties.phone + '">' + currentFeature.properties.phone + '</a>').addTo(map);
}
